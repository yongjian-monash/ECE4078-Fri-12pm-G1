...
def calibrateWheelRadius():
    ...
    for delta_time, wheel_vel in zip(delta_times, wheel_velocities_range):
        scale += distance/(delta_time*wheel_vel) # TODO: replace with your code to compute the scale parameter using wheel_vel and delta_time
